...
class EnterContact(unittest.TestCase):
    ...
    def test_enter_contact(self):
        ...
        self.contact_creation(wd, contact(firstname="Anton", middlename="Wiktor", lastname="Lund", nickname="alund", title="Cola", company="Coca Cola", address="Kungsgatan 11, lgh 4", home="City",
